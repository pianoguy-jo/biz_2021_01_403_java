...
import com.callor.oop.service.impl.CartServiceImpV4;
...
public class Cart_06 {
	...
	public static void main(String[] args) {
		...
		/*
		 * MenuService에서는 선언되지 않고 MenuServiceImplV3에만 선언된 menuItem 변수값을
		...
		Integer selctMenu = ((MenuServiceImplV3)mService).menuItem;
		
		CartService cService = new CartServiceImpV4();
