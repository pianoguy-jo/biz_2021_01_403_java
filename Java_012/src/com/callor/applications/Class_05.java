...
public class Class_05 {
	...
	public static void main(String[] args) {
		 ...
		 * 단, 출력후 줄바꿈을 하지 않아 이후 출력되는 결과가 이어서(옆으로) 출력
		 * 또한, ()안의 내용을 생략할 수 없다.
		 */
		...
		// 실수표현 : %f
		//실수 표현 정수부분 3자리 소숫점 부분 2자리(3번째에서 반올림)
